...
.switch-button-control {
    ...
    .switch-button {
        ...
        height: calc($switch-button-height + $switch-button-border-enabled-thickness);
        width: calc(#{$switch-button-height} * 2 + #{$switch-button-border-enabled-thickness});
        ...
        &.enabled {
            ...
            border: $switch-button-border-enabled-thickness solid $switch-button-background-color;
